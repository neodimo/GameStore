...
Media discovery begins 600 ms after startup as a non-blocking three-worker audit. It shares provider indexes, fills missing screenshots, and publishes per-title records for instant detail rendering. Opening a title reuses the same in-flight promise. The header reports progress; clearing the disposable cache resets and reruns the audit.
